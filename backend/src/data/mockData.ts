...
export const radioCalls: RadioCall[] = [
  {
    ...
    highlightedPhrase: 'no grip',
    sentiment: 'Negative',
    topic: 'TYRE / GRIP',
    detectedState: 'STRESSED',
    confidence: 91,
    keyPhrases: ['front left', 'no grip', 'slow corners'],
    sector: 'Sector 2',
  ...
  },
  {
    ...
    highlightedPhrase: 'optimal window',
    sentiment: 'Positive',
    topic: 'CAR BALANCE',
    detectedState: 'CALM',
    confidence: 96,
    keyPhrases: ['balance', 'pace', 'optimal window'],
    sector: 'Sector 1',
  ...
  },
  {
    ...
    highlightedPhrase: 'losing concentration',
    sentiment: 'Negative',
    topic: 'GENERAL',
    detectedState: 'TIRED',
    confidence: 84,
    keyPhrases: ['losing concentration', 'drinks bottle', 'laps left'],
    sector: 'Full Lap',
  ...
  },
  {
    ...
    highlightedPhrase: 'clipping heavily',
    sentiment: 'Neutral',
    topic: 'ENGINE / TEMP',
    detectedState: 'CONCERNED',
    confidence: 88,
    keyPhrases: ['engine clipping', 'straight', 'temperatures'],
    sector: 'Sector 3',
